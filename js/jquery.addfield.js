...
$newClone.children("select").eq(0).attr("id",'registro'+newID).val('');
$newClone.children("input").eq(1).attr("id",'sc'+newID).val('');
$newClone.children("input").eq(2).attr("id",'sm'+newID).val('');
$newClone.children("select").eq(3).attr("id",'especie'+newID).val('');
$newClone.children("input").eq(4).attr("id",'plantas'+newID).val('');
$newClone.children("input").eq(4).attr("id",'plantas'+newID).val('');
