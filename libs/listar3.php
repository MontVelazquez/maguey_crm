...
$listado="SELECT no_cliente,nombre,paraje.id_paraje from clientes Inner Join paraje on id_cliente=no_cliente inner join cextracciones on cextracciones.id_paraje=paraje.id_paraje where cextracciones.status=2 group by paraje.id_paraje order by paraje.id_paraje desc";
